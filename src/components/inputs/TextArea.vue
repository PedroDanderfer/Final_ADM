<template>
    <div class="textareaInputComponent">
        <div>
            <label :for="name+'Input'">{{ label }}</label>
            <textarea v-model="value" v-on:input="this.validate" :name="name" :id="name+'Input'" ></textarea>
        </div>
...
<style >
    ...
    .textareaInputComponent >div >textarea{
        width: 100%;
        padding: 5px;
